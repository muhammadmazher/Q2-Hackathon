        ...
        <div>
            <div className="w-full bg-white fixed left-0 right-0 z-50 opacity-10  ">
                ...
                <div className="lg:flex hidden py-4  lg:gap-36 xl:gap-72  justify-end lg:pr-16 xl:pr-20 mx-auto ">
                    <div>
                        <div className="flex gap-14 pl- mt-1 lg:text-base xl:text-lg text-blac font-semibold">
                            ...
                            <Link href="/Contact" className="hover:underline-offset-4 hover:underline hover:decoration-black">Contact</Link>
                        </div>
                    </div>
