        ...
        <div>
            <div className="bg-[#FAF4F4] grid grid-cols-1 md:grid-cols-2 text-center w-full h-full  pb-10 pt-8 md:pr-14 font-[poppins] gap-8 mx-auto">
                <div className="w-12/12 mx-auto">
                    ...
                    <div className="text-center py-4 md:pr-[100px] lg:pr-[120px] lg:pt-[24px] mx-auto">
                        <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold">Side table</h3>
                        <p className="text-base lg:text-lg underline underline-offset-8 pt-2 lg:pt-6 font-semibold"><Link href="/Shop">View More</Link></p>
                    </div>
                </div>
            ...
            <div className="grid bg-[#FFFFFF] w-full h-[1880px] md:h-[1140px] lg:h-[720px] xl:h-[800px] mx-auto font-[poppins]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-8 gap-4 md:gap-x-28 lg:gap-10 xl:gap-24 justify-evenly lg:pt-1 text-center font-medium mx-auto">
                ...
                <div className="w-24 h-9 text-center underline underline-offset-[12px] text-base lg:text-lg mt-6 lg:mt-2 font-semibold decoration-2 hover:text-gray-500 mx-auto">
                        <Link href="/Shop"><p className="">View More</p>
                        </Link>
                    </div>
