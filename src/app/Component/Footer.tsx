    ...
    return (
        <div>
            <div className="w-full h-[480px] justify-items-center sm:flex-col hidden lg:block">
                <div className=" flex  w-full h-[419px] lg:border-b-2 ">
                    ...
                    <div className=" flex w-[640px] h-[312px pl-20">
                        ...
                        <div className=" w-[200px] h-[312px] font-semibold k tracking-wide">
                            ...
                            <Link href="/Shop"><p className="py-6">Shop</p></Link>
                            <Link href="/About"><p className="py-6">About</p></Link>
                            <Link href="/Contact"><p className="py-6">Contact</p></Link>
                        </div>
